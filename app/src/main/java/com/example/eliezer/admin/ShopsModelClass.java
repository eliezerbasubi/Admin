...
public class ShopsModelClass {
    ...
    public ShopsModelClass(String shop_Name, String shop_Description, String shop_Logo, String shop_Address, String shop_Longitude, String shop_Latitude, String shop_User,String status) {
        Shop_Name = shop_Name;
